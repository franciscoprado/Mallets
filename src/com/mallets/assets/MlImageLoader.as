package com.mallets.assets
{
	 ...
	 */
	public class MlImageLoader implements ILoader
	{
		 ...
		 * @param	file_source The path to the file.
		 */
		public function MlImageLoader(id:String, file_source:String):void
		{
			_id = id;
			_file = file_source;
		...
		{
			_complete = true;
			_data = new BitmapData(evt.target.width, evt.target.height, true, 0xffffff);
			_data.draw(evt.target.content);
